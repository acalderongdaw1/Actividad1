...
public class CalcularPeriodo {
	...
	public static void main(String[] args) {
		...
		System.out.println(calcularPeriodo("El descubrimiento de AmÃ©rica", fecha));
		
		LocalDate fecha2 = LocalDate.of(1879, Month.MAY, 5);	 
		System.out.println(calcularPeriodo("La Revolución francesa", fecha2));
		
		LocalDate fecha3 = LocalDate.of(2010, Month.JUNE, 16);	 
		System.out.println(calcularPeriodo("El descubrimiento de AmÃ©rica", fecha3));
	}
